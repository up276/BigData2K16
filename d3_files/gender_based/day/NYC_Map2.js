...
key.selectAll('rect')
    ...
    .attr("x",0)
    .attr("stroke","none")
    .attr("y",function(d,i){return h - 100 - i*( h - 100 )/numBoxes ;})
...
key.append("g")
.attr("class", "y axis")
.attr("transform", "translate(70,00)")
.call(yAxis)
.append("text")
...
console.log(json);
// load data
d3.csv("gender_weekdays", function(error, data) {
...
{return d.gender == gender_val && d.rain_state == current_rain_state_int && d.temp_bin == current_temperature_index_val && d.week_day == week_day_val && d.trip_type == trip_type_val ;}) //&& d.day_hour == day_hour_val 
		.attr("r", "5px")
...
{return  d.gender == gender_val && d.rain_state == current_rain_state_int && d.temp_bin == current_temperature_index_val && d.week_day == week_day_val && d.trip_type == current_trip_type ;}) // && d.day_hour == day_hour_val
		.attr("r", "5px")
                .style("opacity", function(d) { return d.opacityval;})
		//.attr("fill", "red")  
