...
console.log(json);
// load data
d3.csv("hour_nogender/hour_nogender_clean", function(error, data) {
...
{return d.rain_state == current_rain_state_int && d.temp_bin == current_temperature_index_val && d.day_hour == day_hour_val && d.trip_type == trip_type_val ;}) //&& d.day_hour == day_hour_val 
		.attr("r", "5px")
...
{return d.rain_state == current_rain_state_int && d.temp_bin == current_temperature_index_val && d.day_hour == day_hour_val && d.trip_type == current_trip_type ;}) // && d.day_hour == day_hour_val
		.attr("r", "5px")
                .style("opacity", function(d) { return d.opacityval;})
		//.attr("fill", "red")  
